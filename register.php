		...
		<div class="content">
			<form action="register.php" method="post">
				...
				<div class="center">
					...
					<label for="maidenname" style="width: 200px;">Your mother's maiden name?</label><input type="password" name="maidenname" /><br />
					<label for="maidennamerepeat" style="width: 200px;">Repeat: your mother's maiden name?</label><input type="password" name="maidennamerepeat" /><br />
					<label for="elemschool" style="width: 200px;">What elementary school did you attend?</label><input type="password" name="elemschool" /><br />
					<label for="elemschoolrepeat" style="width: 200px;">Repeat: what elementary school did you attend?</label><input type="password" name="elemschoolrepeat" /><br />
					<label for="road" style="width: 200px;">What is the name of the road you grew up on?</label><input type="password" name="road" /><br />
					<label for="roadrepeat" style="width: 200px;">Repeat: what is the name of the road you grew up on?</label><input type="password" name="roadrepeat" /><br />					
